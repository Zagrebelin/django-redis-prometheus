...
CACHES = {
    'default': {
        'BACKEND': 'django_redis_prometheus.cache.backends.memcached.MemcachedCache',
    ...
    'locmem': {
        'BACKEND': 'django_redis_prometheus.cache.backends.locmem.LocMemCache',
        'LOCATION': '/var/tmp/locmem_cache',
    },
    'redis': {
        'BACKEND': 'django_redis_prometheus.cache.backends.redis.RedisCache',
