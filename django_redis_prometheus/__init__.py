...
# objects right away.
from django_redis_prometheus import middleware
from django_redis_prometheus import models
...
default_app_config = 'django_redis_prometheus.apps.DjangoPrometheusConfig'
